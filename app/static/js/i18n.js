...
const EN = {
  ...
  task_cooling_check: 'Photograph the entrance or the posted opening hours. If you can, note whether the entrance has steps or is level. If it is only closed for the day, photograph the posted opening hours: that still counts. If it is blocked, boarded up or under construction, photograph that instead. It is a useful answer and earns full points.',
  ...
  follow_on: 'Following your location', follow_off: 'Stopped following', follow_label_on: 'Following your location. Tap to stop.', follow_label_off: 'Center on my location and follow',
  m_note_label: 'Add a note (optional)', m_note_ph: "Anything the photo can't show: what you did, what you saw, or why it looks this way.",
  m_note_ph_tree_water: 'For example: the soil was bone dry before I watered.', m_note_ph_drain_clear: 'For example: the grate was packed with leaves and I cleared it by hand.',
  m_note_ph_cooling_check: 'For example: closed for the day, and the hours are posted on the door.', m_note_ph_flood_report: 'For example: water is over the curb at this corner.',
  m_note_ph_problem_report: 'For example: the pile is on the sidewalk next to the vacant lot.',
  ...
  code_privacy: 'A face is close up in the photo, or private information is readable. Step back or retake it from a different angle.',
  ...
  prof_weather_test: 'Test weather', force_help: 'Pretend it is hot, dry, or stormy to see the flags those conditions bring. Real weather is used until you change this.',
  force_active: 'Test weather is on for everyone using the app. Tap "Back to real weather" when you are done.', force_applied: 'Test weather applied',
  preset_heat: 'Heat wave', preset_storm: 'Heavy storm', preset_all: 'All at once', preset_real: 'Back to real weather',
  test_key_ask: 'Enter the test key', test_key_bad: 'That key did not work.', test_unlocked: 'Test tools unlocked', test_lock: 'Lock test tools',
  code_forbidden: 'That needs the test key.',
  ...
  menu_about: 'About and data credits', mission_h: 'Our mission', types_h: 'What the flags mean',
  def_tree_title: 'Trees', def_tree: 'Street trees that need water when it is dry and hot, and tree problems neighbors and the city have reported. Shade is the cheapest cooling a block can have. You water a tree at its base, or check on a reported problem.',
  def_drain_title: 'Drains', def_drain: 'Storm drains that could clog before heavy rain, and reported damaged drains. A clear drain keeps a street from flooding. You clear leaves and litter off the top of the grate, and never lift it.',
  def_cooling_title: 'Cooling', def_cooling: 'Libraries, community centers and official cooling centers people can go to in hot weather. You check that the place is open, read its posted hours, and note whether the entrance has steps. Closed or under construction is a useful answer too.',
  def_reports_title: 'Reports', def_reports: 'Problems neighbors and the city have reported, like flooded streets, litter and illegal dumping. You check whether the problem is still there and take a photo from a safe distance.',
