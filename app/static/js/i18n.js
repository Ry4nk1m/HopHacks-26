...
const EN = {
  ...
  rep_title: 'Report a problem', rep_type: 'What do you see?', rep_flood: 'Flooded road', rep_other: 'Other problem',
  ...
  ov_nasa: 'Daily true color (NASA MODIS)', ov_note_ndvi: 'Clear scenes: {dates}', ov_note_lst: 'Scenes: {dates}, about 10:30 am',
  ov_note_nasa: 'Latest daily image, about 250 m per pixel.', ov_low_green: 'Less green', ov_high_green: 'More green', ov_cool: 'Cooler', ov_hot: 'Hotter',
  ...
  mission_body: 'Small tasks add up. Satellites and city data show where a neighborhood could use a hand, the weather says when, and you show up. A photo checked by AI confirms the job got done, so every point on the map is a tree watered, a drain cleared or a cooler place to be.',
  ...
  credit_sat: 'Satellite imagery: Copernicus Sentinel-2 (ESA) and Landsat 9 (NASA/USGS), read from Microsoft Planetary Computer. Daily true color: NASA GIBS / MODIS.',
